...
sidebarTitle: "aiService"
description: "JavaScript module that analyzes resident payment behavior and generates empathic collection message suggestions using Chrome Built-in AI or a local fallback."
---
