...
| `quien` | `'titular'` \| `'sustituto'` \| `null` | Who physically attended (null if absent) |
| `suplente_nombre` | `string` | Full name of the substitute (when `quien === 'sustituto'`) |
| `suplente_cedula` | `string` | National ID (*cédula*) of the substitute |
| `multa` | `number` | Fine in balboas applied on absence (default B/.10.00) |
| `horas` | `number` | Hours contributed (default 4, range 1–12) |
